...
@SpringBootTest
public class skatingApplicationTests {
    ...
    public void generatePdf() throws Exception {
        ...
        skatingApplicationTests.Data data = exampleDataForJohnDoe();
    ...
    private skatingApplicationTests.Data exampleDataForJohnDoe() {
        skatingApplicationTests.Data data = new skatingApplicationTests.Data();
